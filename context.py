...
class ContextCompactor:
	...
	# 整段上下文的触发线。第 1 层的批次门槛由它派生,第 3 层拿它做闸门,
	# 第 4 层(摘要)是它压不下去之后的兜底。
	CONTEXT_CHAR_LIMIT = 50000

	# 单轮一批 tool_result 的字符总和门槛。由上下文预算派生,不是个独立的
	...
	TOOL_RESULT_BATCH_CHAR_LIMIT = CONTEXT_CHAR_LIMIT
